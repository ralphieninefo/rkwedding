...
def find_recent_responses(
    ...
    return mailbox, len(result.get("threads", [])), responses
...
def sync_recent_responses(
    ...
    """Track recent responses in the local cache."""
    mailbox, checked, responses = find_recent_responses(days, max_threads, service)
    newly_found = 0
